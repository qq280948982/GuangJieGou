 ...
 * 
 */
public class OhSwitchView extends CompoundButton
{
	// left and right text
	 ...
	 */
	public OhSwitchView(Context context)
	{
		this(context, null);
	}
	 ...
	 */
	public OhSwitchView(Context context, AttributeSet attrs)
	{
	...
	public OhSwitchView(Context context, AttributeSet attrs, int defStyle)
	{
